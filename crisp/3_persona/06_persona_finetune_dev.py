...
MODEL_NAME_PATH = (
    start.DATA_DIR + f"finetune/{PLATFORM}_{CONCEPT}_persona_finetuned_model_names.xlsx"
)
RESPONSE_PATH = (
    start.DATA_DIR
    + f"responses_dev/{PLATFORM}_{CONCEPT}_persona_finetuned_responses_dev.xlsx"
)
RESULTS_PATH = (
    start.MAIN_DIR + f"results/{PLATFORM}_{CONCEPT}_persona_finetuned_results_dev.xlsx"
)
