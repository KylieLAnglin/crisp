...
# %% Format prompts
positive_example_text = df.loc[153]["text"]
...
for example_index in df[df.human_code == 0].index:

    negative_example_text = df.loc[example_index]["text"]

    example_performance_dict = {}
    example_performance_dict["example_text"] = negative_example_text
