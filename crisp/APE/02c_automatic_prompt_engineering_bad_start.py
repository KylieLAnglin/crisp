...
NUM_GENERATIONS = 5
MODEL = "gpt-4.1"
STARTING_PROMPT = "Negative core beliefs are strong, negative, opinions that a person has about themselves, other people, or how the world works. Does the following writing sample contain one or more negative core beliefs?  Respond Yes or No. Text: "
...
OUTPUT_TRACKING_FILE = start.RESULTS_DIR + "prompt_evolution_tracking_bad_prompt.csv"
...
plt.tight_layout()
# save figure
plt.savefig(start.RESULTS_DIR + "prompt_evolution_tracking_bad_prompt.png")
plt.show()
