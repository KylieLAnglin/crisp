...
NUM_GENERATIONS = 5
MODEL = "gpt-4.1"
STARTING_PROMPT = "Negative core beliefs refer to broad, generalized, or exaggerated judgments people have about themselves, others, or the world. Does the following text contain an example of the psychological concept of a negative core belief? Respond Yes or No. Text:"
...
OUTPUT_TRACKING_FILE = start.RESULTS_DIR + "prompt_evolution_tracking_basic_prompt.csv"
...
plt.show()
# save figure
plt.savefig(start.RESULTS_DIR + "prompt_evolution_tracking_basic_prompt.png")
