###
# Test whether third addition to the prompt improves performance
###
...
destination_path = (
    start.MAIN_DIR + "results/" + PROMPT_FILE + "_additions3_results.xlsx"
)
...
keeper1_text = optionals.loc[OPT_ID_KEEPER1]["prompt_part"]
keeper2_text = optionals.loc[OPT_ID_KEEPER2]["prompt_part"]
optionals = optionals.drop(OPT_ID_KEEPER1)
optionals = optionals.drop(OPT_ID_KEEPER2)
# %%
# Add one
full_prompt_texts = []
opt_ids = []
