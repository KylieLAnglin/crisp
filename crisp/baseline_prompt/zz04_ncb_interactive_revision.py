...
response_df.to_excel(
    start.DATA_DIR + "responses/ncb_best_baseline_classifications.xlsx"
)
# %%
...
PROMPT_FILE = "ncb_interactive_revised_prompt.xlsx"
